...
- [ ] T001 Create `src/utils/retry.ts` with exported `executeWithRetry(fn, classifyError)` implementing exponential backoff (100ms base, full jitter, max 3 attempts) (src/utils/retry.ts)
- [ ] T002 [P] Add transient error status code map constant `TRANSIENT_STATUS_CODES` (src/utils/retry.ts)
- [ ] T003 Add unit test skeleton for retry utility (src/test/utils/retry.test.ts)
- [ ] T004 [P] Register @fastify/multipart plugin in server bootstrap (src/server.ts)
- [ ] T005 Add attachment config constants (max files, max size) (src/const/attachments.ts)
- [ ] T006 [P] Create initial message schemas file exporting placeholder TypeBox objects (src/schemas/message.ts)
- [ ] T007 [P] Create recipient identification schemas file (src/schemas/recipient.ts)
- [ ] T008 [P] Create attachment schemas file (src/schemas/attachment.ts)
- [ ] T009 Extend existing pagination schema with HATEOAS links structure (src/schemas/pagination.ts)
- [ ] T010 Ensure OpenAPI swagger plugin tags include `messages` (src/plugins/external/swagger.ts)
- [ ] T011 [P] Add script comment in quickstart about retry & cleanup behavior (specs/001-messaging-gateway-endpoints/quickstart.md)
- [ ] T012 Add placeholder service files (src/services/profile-service.ts)
- [ ] T013 [P] Add placeholder service files (src/services/messaging-service.ts)
- [ ] T014 [P] Add placeholder service files (src/services/upload-service.ts)
- [ ] T015 Create orchestration service placeholder (src/services/message-orchestration.ts)
- [ ] T016 Add contract tests folder scaffolding (src/test/contracts/message-routes.test.ts)
- [ ] T017 [P] Add messages route index scaffolding (src/routes/messages/index.ts)
- [ ] T018 [P] Add empty handler files for routes (src/routes/messages/send-message.ts)
- [ ] T019 [P] Add empty handler files for routes (src/routes/messages/get-message-events.ts)
- [ ] T020 [P] Add empty handler files for routes (src/routes/messages/get-message-history.ts)
...
- [ ] T027 [P] Implement base profile-service interface & stub methods (src/services/profile-service.ts)
- [ ] T028 [P] Implement base messaging-service interface & stub methods (src/services/messaging-service.ts)
- [ ] T029 [P] Implement base upload-service interface & stub methods (src/services/upload-service.ts)
- [ ] T030 Implement initial route schemas aggregator (src/routes/messages/schema.ts)
- [ ] T031 [P] Add contract test asserting schema presence for all three endpoints (src/test/contracts/message-routes.test.ts)
...
- [ ] T036 [US1] Implement recipient lookup in profile-service (src/services/profile-service.ts)
- [ ] T037 [P] [US1] Implement organization relationship check/create (src/services/profile-service.ts)
- [ ] T038 [US1] Implement upload-service `uploadAttachment(stream, meta)` (src/services/upload-service.ts)
- [ ] T039 [P] [US1] Implement upload-service `shareAttachment(fileId, recipientId)` (src/services/upload-service.ts)
- [ ] T040 [US1] Implement cleanup deletion `deleteAttachment(fileId)` (src/services/upload-service.ts)
- [ ] T041 [US1] Implement messaging-service `sendMessage(payload)` (src/services/messaging-service.ts)
- [ ] T042 [P] [US1] Implement orchestration phase 1 (parse multipart + profile lookup) (src/services/message-orchestration.ts)
- [ ] T043 [P] [US1] Implement orchestration phase 2 (parallel uploads) (src/services/message-orchestration.ts)
- [ ] T044 [P] [US1] Implement orchestration phase 3 (parallel shares) (src/services/message-orchestration.ts)
- [ ] T045 [US1] Implement final send + response assembly (src/services/message-orchestration.ts)
- [ ] T046 [US1] Implement atomic failure handling branch (aggregate errors + cleanup + abort) (src/services/message-orchestration.ts)
- [ ] T047 [US1] Add retry wrapping for transient upload/share errors (src/services/upload-service.ts)
- [ ] T048 [P] [US1] Add retry wrapping for transient messaging send errors (src/services/messaging-service.ts)
- [ ] T049 [US1] Add structured logging for each orchestration phase start/end (src/services/message-orchestration.ts)
- [ ] T050 [US1] Add metrics timers (profile_lookup_duration, upload_phase_duration, cleanup_duration) (src/instrumentation.ts)
- [ ] T051 [P] [US1] Extend schemas for send-message body & response (src/routes/messages/schema.ts)
...
- [ ] T056 [US1] Add integration test: scheduled_at past sends immediately (src/test/routes/messages/send-message.test.ts)
...
- [ ] T062 [US1] Add contract test: send-message swagger schema fields (src/test/contracts/message-routes.test.ts)
